...
<div class="myBody container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 jumbotron">
            ...
            <h2>Add Participant</h2><br/>

            <form:form  method="post" commandName="participantForm" >

                <label>First Name:</label><br>
                <form:input type="name" path = "firstName"/><br>

                <label>Last Name:</label><br>
                <form:input type="name"  path = "lastName" /><br>

                <label>Information1:</label><br>
                <form:textarea  name="text" cols="45" rows="10" maxlength="199" path = "information1" /><br>

                <label>Information2:</label><br>
                <form:textarea  name="text" cols="45" rows="10" path = "information2" /><br><br>

                <label>Photo:</label><br>
                <form:input type="link" path = "photoUrl" /><br><br>
